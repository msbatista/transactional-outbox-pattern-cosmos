...
public class Contact : DomainEntity, IAggregateRoot, IContact
{
    ...
    public void SetCompany(string companyName, string street, string houseNumber, string postalCode, string city, string country)
    {
